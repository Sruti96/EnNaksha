              ...
              <div className="bg-warm-brown/[0.07] border-t-2 border-warm-brown/20 px-7 py-6 flex-1 flex flex-col justify-between relative">
                ...
                <div>
                  <div className="flex gap-0.5 mb-3">
                    {[...Array(5)].map((_, j) => <span key={j} className="text-yellow-500 text-[16px]">★</span>)}
                  </div>
                  <p className="font-inter text-[15px] italic text-charcoal/80 leading-[1.75] mb-5">&ldquo;{p.quote}&rdquo;</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-warm-brown text-ivory flex items-center justify-center font-inter font-bold text-sm flex-shrink-0">{p.initials}</div>
                  <div>
